...
public class CMBKPSPublicSoap
{
    ...
    public CMBKPSPublicSoap(){}

    public CMBKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public CMBKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        CMBExtendedSoapSerializationEnvelope envelope= new CMBExtendedSoapSerializationEnvelope(CMBExtendedSoapSerializationEnvelope.VER11);
