...
public class CMBExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(CMBDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new CMBStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static CMBDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static CMBDateTimeConverter dateTimeConverter = new CMBStandardDateTimeConverter();

    public CMBExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public CMBExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new CMBMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=CMBHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,CMBExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=CMBHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
